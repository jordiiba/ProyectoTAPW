...
@section('titulo', 'Actualiza - Proveedor')
    ...
    <form action="#" method="POST" id="form_proveedor">
        <div style="margin-left: 30%; margin-right: 30%">
            ...
            <div class="form-group">
                ...
                <input id="nombre" class="form-control" type="text" value = "{{$proveedor->nombre}}">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Direccion</label>
                <input id="direccion" class="form-control" type="text" value = "{{$proveedor->direccion}}">
            </div>
    ...
    <script type="text/javascript">
        ...
        $('#form_proveedor').submit(function(e) {
            ...
            */
            ...
            //console.log(data);
            var request = $.ajax({
                url: '/proveedor/actualiza/{!!$proveedor->id!!}',
                type: "PUT",
                data: {
                    nombre: $('#nombre').val(),
